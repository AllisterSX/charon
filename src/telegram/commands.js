...
export async function handleMessage(msg) {
  ...
  if (text.startsWith('/strategy')) {
    ...
    const valid = ['obicle_confirmed', 'graduation_pump', 'migration_play', 'degen_micro'];
